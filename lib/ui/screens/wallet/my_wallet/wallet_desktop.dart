...
class _WalletDesktopState extends State<WalletDesktop> {
  ...
  Widget _walletDesktop(List<TrxHistoryModel> history, String userWallet,
      String balance, context) {
    return ReuseDesktop(
                              ...
                              onTap: () async {
                                await Components.dialog(
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ItemList(
                                          title: "Id", trailing: history[i].id),
                                      ItemList(
                                        title: "Created At",
                                      ...
                                      ItemList(
                                          title: "Fee",
                                          trailing: history[i].fee.toString()),
                                      ItemList(
                                          title: "Memo",
