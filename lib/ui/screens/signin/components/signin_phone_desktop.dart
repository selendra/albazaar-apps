...
class SignInPhoneDesktop extends StatelessWidget {
  ...
  SignInPhoneDesktop(this.signInPhoneFunc, this.facebookSignIn,
      this.googleSignIn, this.hover, this.hovering);
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              width: MediaQuery.of(context).size.width * 0.3,
              child: ReuseButton.getItem(_lang.translate('signin_string'), () {
                validateAndSubmit();
              }, context),
            ),
            SizedBox(height: 10),
