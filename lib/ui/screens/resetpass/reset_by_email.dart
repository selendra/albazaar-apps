...
import 'package:selendra_marketplace_app/ui/screens/signin/signin.dart';
...
class ResetByEmail extends StatelessWidget {
  ...
  resetbyEmail(String tempCode, String email, String password, context) async {
    String apiUrl =
        "https://testnet-api.selendra.com/pub/v1/reset-password-by-email";
  ...
  _btnLogin(context) {
    return Container(
      ...
      child: RaisedButton(
        onPressed: () {
          resetbyEmail(tempCodeController.text, emailController.text,
