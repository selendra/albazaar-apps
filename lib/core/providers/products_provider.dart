...
class ProductsProvider with ChangeNotifier {
  ...
  //     if (value == null) {
  //       _http.Response response = await _http
  //           .get('https://data.wa.gov/resource/tgdf-dvhm.json', headers: {
  ...
  //           Product(
  //             id: element['id'],
  //             thumbnail: myImageUrl,
  //             name: element['fruit'],
  //             price: element['price'],
  //           )
  //         });
  //       });
  //       await toJson(data).then(
  //           (value) async => await StorageServices.setData(value, 'fruit'));
  //     } else {
  ...
  //             name: element['title'], // fruit: element['fruit'],
  ...
  void addItem(String _title, double _price, String _description,
    ...
    //     color: 'FF3D82AE'));
    // toJson(data)
    //     .then((value) async => {await StorageServices.setData(value, 'fruit')});
    // notifyListeners();
  }
